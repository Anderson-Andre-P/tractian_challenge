...
class EmployeeListItemThemeData
    extends ThemeExtension<EmployeeListItemThemeData> {
  ...
  @override
  EmployeeListItemThemeData lerp(
      ThemeExtension<EmployeeListItemThemeData>? other, double t) {
